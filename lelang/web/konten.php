...
if( $page == 'barang'){
  ...
  <div class="site-section">
          <div class="container">
            <?php 
            $pd = mysqli_query($koneksi,"SELECT * FROM barang WHERE kategori = 'motor'");
            $gd = mysqli_query($koneksi,"SELECT * FROM barang WHERE kategori = 'mobil'");
            
            $jml_pd = mysqli_num_rows($pd);
            $jml_gd = mysqli_num_rows($gd); //var_dump($jml_gd);
            ?>
            <div class="row">
              <div class="col-md-3">
                <div class="side-box mb-5">
                  ...
                  <ul class="list-unstyled auction-categories">
                    <li><a href="#">Padi <span><?=$jml_pd?></span></a></li>
                    <li><a href="#">Gandum <span><?=$jml_gd?></span></a></li>
                  </ul>
                </div>
            ...
            <div class="col-lg-6">
              ...
              <?php 
                ...
                function add_message($data) {
                  ...
                  $tel_number = htmlspecialchars($data["tel_number"]);

                  $message = htmlspecialchars($data["message"]);
                  

                  
                  mysqli_query($conn, "INSERT INTO message VALUES('', '$first_name', '$last_name', '$email', '$tel_number', '$message')");
                ...
                if (isset($_POST["register"])) {
                  ...
                  if (add_message($_POST) > 0 ) {
                     echo "<script>
                        alert('Message Successfull Submited!');
                        window.location.href='main.php?page=kontak';
                      </script>";
                  } else {
                ...
                <form action="" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                      ...
                      <input type="text" id="tel" name="tel_number" class="form-control form-control-lg">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12 form-group">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <button type="submit" name="register" class="btn btn-primary btn-lg px-5">Send Message</button>
                    </div>
                  </div>
